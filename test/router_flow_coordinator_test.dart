...
void main() {
  group('RouterFlowCoordinatorState', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final routerWidget2 = tester.widget<Router<TestConfigurationType>>(
            find.byType(Router<TestConfigurationType>));
        expect(
            routerWidget2.backButtonDispatcher, equals(mockChildDispatcher2));
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final initialRouterWidget =
            tester.widget<Router<TestConfigurationType>>(
                find.byType(Router<TestConfigurationType>));
        expect(
            initialRouterWidget.backButtonDispatcher, equals(childDispatcher));
        ...
        final updatedRouterWidget =
            tester.widget<Router<TestConfigurationType>>(
                find.byType(Router<TestConfigurationType>));
        verify(rootDispatcher.forget(childDispatcher)).called(1);
        expect(
            updatedRouterWidget.backButtonDispatcher, equals(mockDispatcher));
      },
    );
  });
}
